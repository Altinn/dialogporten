...
internal static class Activity
{
    ...
    public static List<ActivityDto> GetDtos(DialogTimestamp dialogDto) => BuildList<ActivityDto>(dtos =>
    {
        // All dialogs have a DialogCreated activity.
        var dialogCreatedActivityId = CreateUuidV7(dialogDto.Timestamp, nameof(DialogActivity), (int)DialogCreated);
        ...
        if (rng.Next(0, 2) == 0)
        {
            var dialogOpenedActivityId = CreateUuidV7(dialogDto.Timestamp, nameof(DialogActivity), (int)DialogOpened);
        ...
        if (rng.Next(0, 3) == 0)
        {
            var informationActivityId = CreateUuidV7(dialogDto.Timestamp, nameof(DialogActivity), (int)Information);
