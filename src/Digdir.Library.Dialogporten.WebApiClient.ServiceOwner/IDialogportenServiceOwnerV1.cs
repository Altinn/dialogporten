...
public interface IDialogportenServiceOwnerV1
{
    ...
    Task<IApiResponse<DialogLookup>> GetDialogLookupAsync(string instanceRef, V1EndUserCommon_AcceptedLanguages? acceptLanguage = null, CancellationToken cancellationToken = default);
