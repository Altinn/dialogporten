...
{
    [Fact]
    public async Task CollapseSubjectResources_ShouldCollapseCorrectly_WithoutConstraintResources()
    {
        // Arrange
    ...
    [Fact]
    public async Task CollapseSubjectResources_ShouldCollapseCorrectly_WithConstraintResources()
    {
        // Arrange
        var dialogSearchAuthorizationResult = new DialogSearchAuthorizationResult
        {
