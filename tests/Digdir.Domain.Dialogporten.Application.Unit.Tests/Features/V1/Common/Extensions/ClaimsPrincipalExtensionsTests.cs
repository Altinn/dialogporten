...
public class ClaimsPrincipalExtensionsTests
{
    ...
    [Fact]
    public void GetIdentifyingClaims_Should_Handle_Null_Authorization_Details()
    {
        // Arrange
        var claimsPrincipal = new ClaimsPrincipal(new ClaimsIdentity([
    ...
    [Fact]
    public void GetIdentifyingClaims_Should_Handle_Multiple_Authorization_Details_Claims()
    {
        // Arrange
        var claimsPrincipal = new ClaimsPrincipal(new ClaimsIdentity([
            new Claim("authorization_details", "[{\"type\":\"urn:altinn:systemuser\",\"systemuser_id\":[\"first-id\"],\"systemuser_org\":{\"authority\":\"iso6523-actorid-upis\",\"ID\":\"0192:991825827\"},\"system_id\":\"1d81b874-f139-4842-bd0a-e5cc64319272\"}]"),
            new Claim("authorization_details", "[{\"type\":\"urn:altinn:systemuser\",\"systemuser_id\":[\"second-id\"],\"systemuser_org\":{\"authority\":\"iso6523-actorid-upis\",\"ID\":\"0192:991825827\"},\"system_id\":\"1d81b874-f139-4842-bd0a-e5cc64319272\"}]")
        ]));
        ...
        Assert.Contains(identifyingClaims, c => c.Type == "urn:altinn:systemuser" && c.Value == "first-id");
        Assert.Contains(identifyingClaims, c => c.Type == "urn:altinn:systemuser" && c.Value == "second-id");
    }

    [Fact]
    public void GetIdentifyingClaims_Should_Handle_Multiple_SystemUser_Ids_In_Single_Authorization_Detail()
    {
        // Arrange
        var claimsPrincipal = new ClaimsPrincipal(new ClaimsIdentity([
            new Claim("authorization_details", "[{\"type\":\"urn:altinn:systemuser\",\"systemuser_id\":[\"first-id\",\"second-id\"],\"systemuser_org\":{\"authority\":\"iso6523-actorid-upis\",\"ID\":\"0192:991825827\"},\"system_id\":\"1d81b874-f139-4842-bd0a-e5cc64319272\"}]")
        ]));
    ...
    [Fact]
    public void GetIdentifyingClaims_Should_Handle_Multiple_Mixed_Authorization_Details()
    {
        // Arrange
        var claimsPrincipal = new ClaimsPrincipal(new ClaimsIdentity([
            new Claim("authorization_details", "[{\"type\":\"urn:altinn:systemuser\",\"systemuser_id\":[\"first-id\"]},{\"type\":\"other_type\",\"some_id\":\"ignored\"},{\"type\":\"urn:altinn:systemuser\",\"systemuser_id\":[\"second-id\"]}]")
        ]));
