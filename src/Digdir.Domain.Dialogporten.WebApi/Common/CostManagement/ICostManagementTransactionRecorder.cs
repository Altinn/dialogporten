...
/// <summary>
/// Service for recording individual cost management transactions
/// </summary>
public interface ICostManagementTransactionRecorder
{
    /// <summary>
    /// Records a single transaction for cost management metrics
    /// </summary>
