...
internal sealed class SaveChangesForbiddenUnitOfWork(IUnitOfWork inner) : IUnitOfWork
{
    ...
    public IUnitOfWork DisableAggregateFilter() => _inner.DisableAggregateFilter();

    public IUnitOfWork DisableVersionableFilter() => _inner.DisableVersionableFilter();

    public IUnitOfWork DisableUpdatableFilter() => _inner.DisableUpdatableFilter();

    public IUnitOfWork DisableSoftDeletableFilter() => _inner.DisableSoftDeletableFilter();

    public IUnitOfWork DisableImmutableFilter() => _inner.DisableImmutableFilter();
}
