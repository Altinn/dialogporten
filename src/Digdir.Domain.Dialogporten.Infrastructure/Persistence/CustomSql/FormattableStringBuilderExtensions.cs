...
internal static class FormattableStringBuilderExtensions
{
    public static Task<PaginatedList<TTarget>> ToPaginatedListAsync<TOrderDefinition, TTarget>
        (this DbContext db,
        FormattableStringBuilder query,
    ...
    internal static FormattableStringBuilder ApplyPaginationOrder<T>(this FormattableStringBuilder builder, IOrderSet<T> orderSet)
    {
    ...
    [SuppressMessage("Performance", "CA1859:Use concrete types when possible for improved performance")]
    internal static FormattableStringBuilder ApplyPaginationCondition<T>(
        this FormattableStringBuilder builder,
        IOrderSet<T> orderSet,
        IContinuationTokenSet? continuationTokenSet)
    {
    ...
    internal static FormattableStringBuilder ApplyPaginationLimit(this FormattableStringBuilder builder, int limit) =>
        builder.Append((string)$" LIMIT {limit} ");

    private static FormattableStringBuilder CreateLessThanGreaterThanPart(this FormattableStringBuilder builder, OrderPart orderPart) =>
    ...
    private static FormattableStringBuilder CreateEqualsPart(this FormattableStringBuilder builder, OrderPart x) =>
        x.Value is not null
