...
public record EntityNotFound(string Name, IEnumerable<object> Keys) //: ApplicationReturnBase
{
...
public record ApplicationReturnBase
{
    public required ProblemInstance ProblemInstance { get; set; }
}
