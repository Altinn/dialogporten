...
namespace Altinn.ApiClients.Dialogporten.EndUser.Features.V1
{
    ...
    public interface IEnduserApi
    {
        ...
        Task<IApiResponse<ICollection<LabelAssignmentLog>>> SearchDialogLabelAssignmentLogs(
        ...
        Task<IApiResponse> SetDialogSystemLabels(
            Guid dialogId, [Body, AliasAs("SetDialogSystemLabelRequest")] SetDialogSystemLabelRequest setDialogSystemLabelRequest, [Header("if-Match")] Guid? ifMatch = null,
            [Property("Altinn.ApiClients.Maskinporten.RequestContext")] MaskinportenRequestContext? requestContext = null, CancellationToken cancellationToken = default);
        ...
        Task<IApiResponse> BulkSetDialogSystemLabels(
            [Body] BulkSetSystemLabel dto, [Property("Altinn.ApiClients.Maskinporten.RequestContext")] MaskinportenRequestContext? requestContext = null, CancellationToken cancellationToken = default);
        ...
        Task<IApiResponse<ICollection<DialogActivitySearchItem>>> SearchDialogActivities(
            Guid dialogId, [Header("accept-Language")] AcceptedLanguages? acceptLanguage = null,
            [Property("Altinn.ApiClients.Maskinporten.RequestContext")] MaskinportenRequestContext? requestContext = null, CancellationToken cancellationToken = default);
        ...
        Task<IApiResponse<PaginatedListOfDialogListItem>> SearchDialogs(
            [Query] SearchDialogsQueryParams? queryParams = null, [Header("accept-Language")] AcceptedLanguages? acceptLanguage = null,
            [Property("Altinn.ApiClients.Maskinporten.RequestContext")] MaskinportenRequestContext? requestContext = null, CancellationToken cancellationToken = default);
        ...
        Task<IApiResponse<DialogTransmissionDetails>> GetDialogTransmission(
            Guid dialogId, Guid transmissionId, [Header("accept-Language")] AcceptedLanguages? acceptLanguage = null,
            [Property("Altinn.ApiClients.Maskinporten.RequestContext")] MaskinportenRequestContext? requestContext = null, CancellationToken cancellationToken = default);
        ...
        Task<IApiResponse<DialogSeenLogDetails>> GetDialogSeenLog(
            Guid dialogId, Guid seenLogId, [Property("Altinn.ApiClients.Maskinporten.RequestContext")] MaskinportenRequestContext? requestContext = null,
        ...
        Task<IApiResponse<Dialog>> GetDialog(
            Guid dialogId, [Header("accept-Language")] AcceptedLanguages? acceptLanguage = null,
            [Property("Altinn.ApiClients.Maskinporten.RequestContext")] MaskinportenRequestContext? requestContext = null, CancellationToken cancellationToken = default);
        ...
        Task<IApiResponse<EndUserIdentifierLookup>> GetDialogLookup(
            [Query] string instanceRef, [Header("accept-Language")] AcceptedLanguages? acceptLanguage = null,
            [Property("Altinn.ApiClients.Maskinporten.RequestContext")] MaskinportenRequestContext? requestContext = null, CancellationToken cancellationToken = default);
        ...
        Task<IApiResponse<Parties>> GetParties(
            [Property("Altinn.ApiClients.Maskinporten.RequestContext")] MaskinportenRequestContext? requestContext = null, CancellationToken cancellationToken = default);
    }
}
