...
public static class ServiceCollectionExtensions
{
    ...
    {
        public IServiceCollection AddDialogportenClient(DialogportenSettings settings)
        {
        ...
        public IServiceCollection AddDialogportenClient(Action<DialogportenSettings> configureOptions)
        {
