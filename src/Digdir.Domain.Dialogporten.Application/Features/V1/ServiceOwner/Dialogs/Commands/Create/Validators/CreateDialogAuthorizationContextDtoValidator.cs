...
internal sealed class CreateDialogAuthorizationContextDtoValidator : AbstractValidator<AuthorizationContextDto>
{
    public CreateDialogAuthorizationContextDtoValidator()
    {
...
internal sealed class CreateDialogChildAuthorizationContextDtoValidator : AbstractValidator<ChildAuthorizationContextDto>
{
    public CreateDialogChildAuthorizationContextDtoValidator()
    {
        RuleFor(x => x.ServiceResource)
            .IsValidAuthorizationAttribute()
            .Must(x => x is null || x.StartsWith(Constants.ServiceResourcePrefix, StringComparison.OrdinalIgnoreCase))
