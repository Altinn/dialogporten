...
internal static class Constants
{
    ...
    internal static class SwaggerSummary
    {
        ...
        internal const string AuthenticationFailure = "Missing or invalid authentication token. Please verify your access token.";
        internal const string AuthorizationFailure = "This endpoint requires a token from {0} with the scope(s) \"{1}\".";
        ...
        internal const string AccessDeniedToDialog = "Unauthorized to {0} the supplied dialog (not owned by authenticated organization).";
        internal const string AccessDeniedToDialogForChildEntity = "Unauthorized to {0} child entity for the given dialog (not owned by authenticated organization).";
        internal const string DialogCreationNotAllowed = "Unauthorized to create a dialog for the given serviceResource (not owned by authenticated organization).";
