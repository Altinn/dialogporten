...
public class DialogDto
{
    ...
    /// Use <see cref="Application.Features.V1.EndUser.Dialogs.Queries.Search.DialogEndUserContextDto.SystemLabels"/> on <see cref="EndUserContext"/> instead.
    /// </summary>
    [Obsolete($"Use {nameof(EndUserContext)}.{nameof(Application.Features.V1.EndUser.Dialogs.Queries.Search.DialogEndUserContextDto.SystemLabels)} instead.")]
