...
internal sealed class UpdateDialogAuthorizationContextDtoValidator : AbstractValidator<AuthorizationContextDto>
{
    public UpdateDialogAuthorizationContextDtoValidator()
    {
...
internal sealed class UpdateDialogChildAuthorizationContextDtoValidator : AbstractValidator<ChildAuthorizationContextDto>
{
    public UpdateDialogChildAuthorizationContextDtoValidator()
    {
        RuleFor(x => x.ServiceResource)
            .IsValidAuthorizationAttribute()
            .Must(x => x is null || x.StartsWith(Constants.ServiceResourcePrefix, StringComparison.OrdinalIgnoreCase))
