...
const serverVus = __ENV.SERVER_VUS ? parseInt(__ENV.SERVER_VUS) : 0;
const clientVus = __ENV.CLIENT_VUS ? parseInt(__ENV.CLIENT_VUS) : 2000;
...
const no_of_endusers = __ENV.NUMBER_OF_ENDUSERS ? parseInt(__ENV.NUMBER_OF_ENDUSERS) : 1;
