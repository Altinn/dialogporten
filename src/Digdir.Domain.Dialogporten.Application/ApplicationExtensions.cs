...
public static class ApplicationExtensions
{
    ...
    {
        public IServiceCollection AddApplication(IConfiguration configuration, IHostEnvironment environment)
        {
        ...
        private IServiceCollection AddServiceResourceResolvers(params IEnumerable<Assembly> assemblies)
        {
