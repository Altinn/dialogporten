...
internal sealed class UpdateTransmissionAuthorizationContextDtoValidator : AbstractValidator<AuthorizationContextDto>
{
    public UpdateTransmissionAuthorizationContextDtoValidator()
    {
...
internal sealed class UpdateTransmissionChildAuthorizationContextDtoValidator : AbstractValidator<ChildAuthorizationContextDto>
{
    public UpdateTransmissionChildAuthorizationContextDtoValidator()
    {
        RuleFor(x => x.ServiceResource)
            .IsValidAuthorizationAttribute()
            .Must(x => x is null || x.StartsWith(Constants.ServiceResourcePrefix, StringComparison.OrdinalIgnoreCase))
