...
public static class AltinnAuthorizationExtensions
{
    ...
    {
        var authorizationResult = await altinnAuthorization.GetDialogDetailsAuthorization(
            dialog,
            cancellationToken
        );
        ...
        var hasListAuthorization = await altinnAuthorization.HasListAuthorizationForDialog(
            dialog,
            cancellationToken
        );
