...
public sealed class NotificationConditionEndpointSummary : Summary<NotificationConditionEndpoint, NotificationConditionQuery>
{
    public NotificationConditionEndpointSummary()
    {
        ...
        Responses[StatusCodes.Status401Unauthorized] = Constants.SwaggerSummary.ServiceOwnerAuthenticationFailure.FormatInvariant(
            $"{AuthorizationScope.ServiceProvider} {AuthorizationScope.NotificationConditionCheck}");
