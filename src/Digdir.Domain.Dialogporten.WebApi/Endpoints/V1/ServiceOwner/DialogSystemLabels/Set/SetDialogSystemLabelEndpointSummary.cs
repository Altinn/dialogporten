...
public sealed class SetDialogSystemLabelEndpointSummary : Summary<SetDialogSystemLabelEndpoint>
{
    public SetDialogSystemLabelEndpointSummary()
    {
        Summary = "Sets the system label of a dialog";
        Description = $"""
                       Sets the system label of the dialog.
