...
public class UpdateDialogServiceOwnerLabelsTests : ApplicationCollectionFixture
{
    public UpdateDialogServiceOwnerLabelsTests(DialogApplication application) : base(application) { }
