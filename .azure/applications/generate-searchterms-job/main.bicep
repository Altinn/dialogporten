...
var name = '${namePrefix}-gen-searchterms'

var additionalTags = {
  FullName: '${namePrefix}-generate-searchterms'
  Description: 'Generates the per-language search-term lists served from /metadata/searchterms'
  JobType: 'Scheduled'
}
...
module generateSearchTermsJob '../../modules/containerAppJob/main.bicep' = {
  name: name
  params: {
    name: name
    location: location
...
output name string = generateSearchTermsJob.outputs.name
