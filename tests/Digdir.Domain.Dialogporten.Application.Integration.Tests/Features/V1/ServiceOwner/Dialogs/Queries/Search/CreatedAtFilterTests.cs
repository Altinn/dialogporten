...
//     {
//         // Using FlowBuilder for search query execution
//         var dialogIn2020 = await CreateDialogInYear(2020);
//         var dialogIn2021 = await CreateDialogInYear(2021);
//         var dialogIn2022 = await CreateDialogInYear(2022);
//         var dialogIn2023 = await CreateDialogInYear(2023);
//
//         await FlowBuilder.For(Application)
//             .SendCommand((_, _) => new SearchDialogQuery
//             {
...
//             })
//             .ExecuteAndAssert<PaginatedList<SearchDialogResponseDto>>(result =>
//             {
...
//     }
//
//     private async Task<Guid> CreateDialogInYear(int year)
//     {
//         var command = DialogGenerator.GenerateFakeCreateDialogCommand(createdAt: CreateDateFromYear(year));
//         var response = await Application.Send(command);
//         return response.AsT0.DialogId;
//     }
//
//     [Fact]
