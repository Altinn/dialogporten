...
internal abstract class AuthorizationContextDtoValidatorBase<T> : AbstractValidator<T>
    where T : class, IAuthorizationContextDtoBase
{
    protected AuthorizationContextDtoValidatorBase()
    {
...
internal sealed class AuthorizationContextDtoValidator : AuthorizationContextDtoValidatorBase<AuthorizationContextDto>
{
...
internal sealed class ChildAuthorizationContextDtoValidator : AuthorizationContextDtoValidatorBase<ChildAuthorizationContextDto>;
