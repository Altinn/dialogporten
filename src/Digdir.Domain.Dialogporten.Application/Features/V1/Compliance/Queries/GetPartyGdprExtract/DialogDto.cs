...
/// <summary>
/// Removed fields
/// - DialogTransmissionDto.IsOpened
/// - DialogDto.IsContentSeen
/// - DialogSeenLogDto.IsCurrentEndUser
/// </summary>
public sealed class DialogDto
{
    ...
    /// <summary>
    /// The list of all seen log entries for the dialog.
    /// </summary>
    public List<DialogSeenLogDto> SeenLogs { get; set; } = [];
