...
public class EphemeralDialogDecorator : IServiceownerApi
{
    private readonly IServiceownerApi _serviceownerApi;

    public EphemeralDialogDecorator(IServiceownerApi serviceownerApi)
    {
        _serviceownerApi = serviceownerApi;
    }

    public Task<IApiResponse> V1ServiceOwnerServiceOwnerContextQueriesGetServiceOwnerLabelServiceOwnerLabel(Guid dialogId,
    ...
    public Task<IApiResponse> V1ServiceOwnerServiceOwnerContextCommandsCreateServiceOwnerLabelServiceOwnerLabel(Guid dialogId,
    ...
    public Task<IApiResponse> V1ServiceOwnerServiceOwnerContextCommandsDeleteServiceOwnerLabelServiceOwnerLabel(Guid dialogId, string label,
    ...
    public Task<IApiResponse> V1ServiceOwnerEndUserContextCommandsSetSystemLabelSetDialogSystemLabels(Guid dialogId, string enduserId,
    ...
    public Task<IApiResponse> V1ServiceOwnerEndUserContextCommandsBulkSetSystemLabelsBulkSetDialogSystemLabels(string enduserId,
    ...
    public Task<IApiResponse<ICollection<V1ServiceOwnerDialogsQueriesSearchTransmissions_Transmission>>> V1ServiceOwnerDialogsQueriesSearchTransmissionsDialogTransmission(Guid dialogId,
        CancellationToken cancellationToken = default) =>
        _serviceownerApi.V1ServiceOwnerDialogsQueriesSearchTransmissionsDialogTransmission(dialogId, cancellationToken);

    public Task<IApiResponse<string>> V1ServiceOwnerDialogsCommandsCreateTransmissionDialogTransmission(Guid dialogId,
    ...
    public Task<IApiResponse<ICollection<V1ServiceOwnerDialogsQueriesSearchSeenLogs_SeenLog>>> V1ServiceOwnerDialogsQueriesSearchSeenLogsDialogSeenLog(Guid dialogId,
        CancellationToken cancellationToken = default) =>
        _serviceownerApi.V1ServiceOwnerDialogsQueriesSearchSeenLogsDialogSeenLog(dialogId, cancellationToken);

    public Task<IApiResponse<PaginatedListOfV1ServiceOwnerDialogsQueriesSearchEndUserContext_DialogEndUserContextItem>> V1ServiceOwnerDialogsQueriesSearchEndUserContextDialogEndUserContext(
    ...
    public Task<IApiResponse<ICollection<V1ServiceOwnerDialogsQueriesSearchActivities_Activity>>> V1ServiceOwnerDialogsQueriesSearchActivitiesDialogActivity(Guid dialogId,
        CancellationToken cancellationToken = default) =>
        _serviceownerApi.V1ServiceOwnerDialogsQueriesSearchActivitiesDialogActivity(dialogId, cancellationToken);

    public Task<IApiResponse<string>> V1ServiceOwnerDialogsCommandsCreateActivityDialogActivity(Guid dialogId,
    ...
    public Task<IApiResponse<PaginatedListOfV1ServiceOwnerDialogsQueriesSearch_Dialog>> V1ServiceOwnerDialogsQueriesSearchDialog(V1ServiceOwnerDialogsQueriesSearchDialogQueryParams queryParams,
        CancellationToken cancellationToken = default) =>
        _serviceownerApi.V1ServiceOwnerDialogsQueriesSearchDialog(queryParams, cancellationToken);

    public Task<IApiResponse<string>> V1ServiceOwnerDialogsCommandsCreateDialog(V1ServiceOwnerDialogsCommandsCreate_Dialog dto,
        CancellationToken cancellationToken = default)
    {
        ...
        return _serviceownerApi.V1ServiceOwnerDialogsCommandsCreateDialog(dto, cancellationToken);
    }

    public Task<IApiResponse<V1ServiceOwnerDialogsQueriesNotificationCondition_NotificationCondition>> V1ServiceOwnerDialogsQueriesNotificationConditionNotificationCondition(Guid dialogId,
    ...
    public Task<IApiResponse<V1ServiceOwnerDialogsQueriesGetTransmission_Transmission>> V1ServiceOwnerDialogsQueriesGetTransnissionDialogTransmission(Guid dialogId, Guid transmissionId,
        CancellationToken cancellationToken = default) =>
        _serviceownerApi.V1ServiceOwnerDialogsQueriesGetTransnissionDialogTransmission(dialogId, transmissionId, cancellationToken);

    public Task<IApiResponse<V1ServiceOwnerDialogsQueriesGetSeenLog_SeenLog>> V1ServiceOwnerDialogsQueriesGetSeenLogDialogSeenLog(Guid dialogId, Guid seenLogId,
        CancellationToken cancellationToken = default) =>
        _serviceownerApi.V1ServiceOwnerDialogsQueriesGetSeenLogDialogSeenLog(dialogId, seenLogId, cancellationToken);

    public Task<IApiResponse<V1ServiceOwnerDialogsQueriesGetActivity_Activity>> V1ServiceOwnerDialogsQueriesGetActivityDialogActivity(Guid dialogId, Guid activityId,
        CancellationToken cancellationToken = default) =>
        _serviceownerApi.V1ServiceOwnerDialogsQueriesGetActivityDialogActivity(dialogId, activityId, cancellationToken);

    public Task<IApiResponse<V1ServiceOwnerDialogsQueriesGet_Dialog>> V1ServiceOwnerDialogsQueriesGetDialog(Guid dialogId, string endUserId,
        CancellationToken cancellationToken = default) =>
        _serviceownerApi.V1ServiceOwnerDialogsQueriesGetDialog(dialogId, endUserId, cancellationToken);

    public Task<IApiResponse> V1ServiceOwnerDialogsCommandsUpdateDialog(Guid dialogId, V1ServiceOwnerDialogsCommandsUpdate_Dialog dto,
        Guid? if_Match, CancellationToken cancellationToken = default) =>
        _serviceownerApi.V1ServiceOwnerDialogsCommandsUpdateDialog(dialogId, dto, if_Match, cancellationToken);

    public Task<IApiResponse> V1ServiceOwnerDialogsCommandsDeleteDialog(Guid dialogId, Guid? if_Match,
        CancellationToken cancellationToken = default) =>
        _serviceownerApi.V1ServiceOwnerDialogsCommandsDeleteDialog(dialogId, if_Match, cancellationToken);

    public Task<IApiResponse> V1ServiceOwnerDialogsPatchDialog(Guid dialogId, IEnumerable<JsonPatchOperations_Operation> patchDocument, Guid? etag,
        CancellationToken cancellationToken = default) =>
        _serviceownerApi.V1ServiceOwnerDialogsPatchDialog(dialogId, patchDocument, etag, cancellationToken);

    public Task<IApiResponse> V1ServiceOwnerDialogsCommandsRestoreDialog(Guid dialogId, Guid? if_Match,
        CancellationToken cancellationToken = default) =>
        _serviceownerApi.V1ServiceOwnerDialogsCommandsRestoreDialog(dialogId, if_Match, cancellationToken);

    public Task<IApiResponse> V1ServiceOwnerDialogsCommandsPurgeDialog(Guid dialogId, Guid? if_Match,
        CancellationToken cancellationToken = default) =>
        _serviceownerApi.V1ServiceOwnerDialogsCommandsPurgeDialog(dialogId, if_Match, cancellationToken);

    public Task<IApiResponse> V1ServiceOwnerDialogsCommandsFreezeFreezeDialog(Guid dialogId, Guid? if_Match,
        CancellationToken cancellationToken = default) =>
