...
public sealed class DialogApiActionDto
{
    ...
    ///
    /// Null when the action was supplied with an authorizationContext, in which case the action is found in
...
public sealed class AuthorizationContextDto
{
    ...
    /// <summary>
    /// The XACML action to evaluate. Null on transmissions when the default derivation applies ("read" when
    /// "serviceResource" is set, otherwise "transmissionread").
    /// </summary>
